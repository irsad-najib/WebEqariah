  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col md:flex-row lg:flex-row items-center bg-gray-200">
        {/* Left Section */}
        <div className="bg-gray-200 md:w-[60%] lg:min-h-screen flex justify-center items-center lg:items-end flex-col pt-10 pb-10">
        ...
        {/* Right Section */}
        <div className="h-[740px] md:w-[35%] flex items-center" style={{ minHeight: '100vh' }}>
          <div className="lg:ml-10 flex flex-cols w-full justify-center">
            <div className="pt-10 bg-white p-12 rounded-lg shadow-lg max-w-md w-full">
